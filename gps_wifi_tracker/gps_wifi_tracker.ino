...
// Кастомный шрифт с поддержкой кириллицы (DejaVu Sans, 16px, ASCII+Cyrillic).
// Файл lv_font_ru_16.c лежит рядом со скетчем и компилируется автоматически.
extern "C" const lv_font_t lv_font_ru_16;
...
static void buildIdleScreen() {
    ...
    lv_obj_set_style_text_font(idleStatusLabel, &lv_font_ru_16, 0);
    ...
    lv_obj_set_style_text_font(idleWifiLabel, &lv_font_ru_16, 0);
    ...
    lv_obj_set_style_text_font(idleTimeLabel, &lv_font_ru_16, 0);
    ...
    lv_obj_set_style_text_font(idleHintLabel, &lv_font_ru_16, 0);
...
static void buildRecScreen() {
    ...
    lv_obj_set_style_text_font(recTableLabel, &lv_font_ru_16, 0);
...
static void buildStoppedScreen() {
    ...
    lv_obj_set_style_text_font(label, &lv_font_ru_16, 0);
